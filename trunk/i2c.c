...
void i2c_write(unsigned char device_addr, unsigned char command, unsigned char *data, int n)
{
...
void i2c_read(unsigned char device_addr, unsigned char command, unsigned char *data, int n)
{
    unsigned char x;
